...
private void __lvl_one_do(void* ptr, game_component_args* args);
private void __lvl_one_draw(void* ptr, game_component_args* args);
private SDL_FPoint __lvl_one_get_player_cord(void* ptr);

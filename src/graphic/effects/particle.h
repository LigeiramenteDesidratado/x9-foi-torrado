...
// Constructor
int particle_ctor(struct particle_t *particle, float mid_x, float mid_y,
                  int width, int height, int phase, int amp, int freq,
                  float spd, direction_t dir, game_component_args *args);

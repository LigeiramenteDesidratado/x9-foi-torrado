...
// Constructor
int background_ctor(struct background_t* background, const char* filename, int w, int h, game_component_args* args);
...
void background_draw(struct background_t* background, game_component_args* args);

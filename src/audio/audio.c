...
private int __audio_load_music(audio_t*, char**);
private int __audio_load_sounds(audio_t* audio, char* filename[SND_MAX]);
...
private int __audio_load_music(audio_t* audio, char* filename[MSC_MAX]) {
